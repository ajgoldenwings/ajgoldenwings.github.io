export function renderFooter() {
  return `
    <footer class="footer footer-center bg-base-200 text-base-content p-10 mt-12">
      ...
      <nav>
        <div class="grid grid-flow-col gap-4">
          <a href="https://github.com/ajgoldenwings" target="_blank" rel="noopener noreferrer" class="btn btn-ghost btn-circle btn-sm">
      ...
      <aside>
        <p class="text-sm opacity-60">Built with Vite, Tailwind CSS & daisyUI</p>
      </aside>
    </footer>
  `;
}
