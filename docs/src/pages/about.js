    ...
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="prose max-w-none">
          <h3>
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 inline-block mr-1 align-text-bottom" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
            </svg>
            Kiro
          </h3>
          <p>
            This site was built using <a href="https://kiro.dev" target="_blank" rel="noopener noreferrer">Kiro</a>,
        ...
        <div class="prose max-w-none">
          <h3>
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 inline-block mr-1 align-text-bottom" fill="currentColor" viewBox="0 0 24 24">
          ...
          <p>
            Source code lives in a public <a href="https://github.com/ajgoldenwings/ajgoldenwings.github.io" target="_blank" rel="noopener noreferrer">GitHub repository</a>.
      ...
      <div class="prose max-w-none">
        <ul>
          <li><strong>Single-page app</strong> — hash-based routing (<code>#/about</code>, <code>#/tools/ai</code>) with no page reloads.</li>
          <li><strong>No framework</strong> — pure ES modules, render functions return template literal HTML.</li>
          <li><strong>Component structure</strong> — shared navbar and footer, page-level modules for each route.</li>
          <li><strong>Theming</strong> — light/dark toggle powered by daisyUI theme controller (retro / halloween).</li>
          <li><strong>Static output</strong> — Vite produces a <code>dist/</code> folder of static assets, no server runtime needed.</li>
        </ul>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="prose text-center">
          <h4>daisyUI 5</h4>
          <p>Component library with semantic class names</p>
        </div>
        <div class="prose text-center">
          <h4>Kiro</h4>
          <p>AI-powered IDE for building with conversation</p>
        </div>
        <div class="prose text-center">
          <h4>GitHub</h4>
          <p>Source control and collaboration platform</p>
        </div>
        <div class="prose text-center">
          <h4>GitHub Actions</h4>
          <p>Automated CI/CD pipeline for deployment</p>
        </div>
      </div>
    </div>
  `;
